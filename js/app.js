        ...
        paralaxMouseInit(paralaxMouse) {
            paralaxMouse.forEach((el => {
                ...
                function setMouseParallaxStyle() {
                    ...
                    if (screen.width > 991.98) el.style.cssText = `transform: translate3D(${directionX * positionX / (paramСoefficientX / 10)}%,${directionY * positionY / (paramСoefficientY / 10)}%,0) rotate(0.02deg);`;
